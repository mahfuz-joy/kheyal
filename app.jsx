...
function App() {
  ...
  const [zenModalData, setZenModalData] = useState(null);
  ...
  return (
    <div className="relative pb-24">
      ...
      <ZenFocusModal
        isOpen={Boolean(zenModalData)}
        onClose={() => setZenModalData(null)}
        title={zenModalData?.title}
        content={zenModalData?.content}
        onSaveContent={zenModalData?.onSave || (() => {})}
      />
